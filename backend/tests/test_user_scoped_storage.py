...
def test_openai_usage_summary_is_user_scoped_and_role_filterable(tmp_path):
    ...
    database.record_openai_usage(
        {
            ...
            "ordinary_input_tokens": 65,
            "output_tokens": 50,
            "reasoning_tokens": 10,
            "total_tokens": 150,
            "estimated_cost_usd": 0.001,
            "effective_input_cost_usd": 0.0008,
            "uncached_input_cost_usd": 0.001,
            "net_cache_savings_usd": 0.0002,
            "elapsed_ms": 900,
    ...
    database.record_openai_usage(
        {
            ...
            "ordinary_input_tokens": 200,
            "output_tokens": 100,
            "reasoning_tokens": 40,
            "total_tokens": 300,
            "estimated_cost_usd": 0.004,
            "effective_input_cost_usd": 0.002,
            "uncached_input_cost_usd": 0.002,
            "net_cache_savings_usd": 0.0,
            "elapsed_ms": 1200,
    ...
    assert summary.totals["cache_write_tokens"] == 10
    assert summary.totals["ordinary_input_tokens"] == 265
    assert summary.totals["net_cache_savings_usd"] == 0.0002
