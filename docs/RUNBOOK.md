...
- Generated lesson audio is uploaded immediately to the authenticated lesson-audio cache and the server retains the five latest generated lessons per user, regardless of completion state.
